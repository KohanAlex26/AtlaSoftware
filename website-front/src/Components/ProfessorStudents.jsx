...
export default function ExamenProfessor() {
    ...
    // const getData = async () => {
    //     fetch('http://cstudent.ddns.net:8080/api/exams', {
    //         method: 'GET',
    ...
    const getData = async () => {
        let url = ""
        // url = 'http://cstudent.ddns.net:8080/api/courses/' + document.getElementById("Id").value
        url = 'http://cstudent.ddns.net:8080/api/courses/eb280205-c3d0-4136-8601-2d8f54dd32b6'
        fetch(url, {
            method: 'GET',
        }).then(r => r.json()).then(data => setA(data))
        let url2 = ""
        url2 = 'http://cstudent.ddns.net:8080/api/course/5a862c8d-adb1-4e18-a26a-51784b52febe'
        fetch(url2, {
            method: 'GET',
        }).then(r => r.json()).then(data => setA(data))
    ...
    const getStudents = async () => {
        let url = ""
        url = 'http://cstudent.ddns.net:8080/api/course/' + document.getElementById("Id").value
        fetch(url, {
            method: 'GET',
        }).then(r => r.json()).then(data => setA(data))
    }
