...
export default function ExamenProfessor() {
    ...
    const getData = async () => {
        fetch('http://cstudent.ddns.net:8080/api/exams/professor/499ed492-ed77-459f-bf1a-402baaee1822', {
            method: 'GET',
    ...
    const addExam = async () => {
        fetch('http://cstudent.ddns.net:8080/api/addExam', {
            method: 'POST',
            headers: {
    ...
    const updateExam = async () => {
        fetch('http://cstudent.ddns.net:8080/api/updateExam', {
            method: 'POST',
            headers: {
                "content-type": "application/json",
            },
    ...
    const removeExam = async () => {
        let url='http://cstudent.ddns.net:8080/api/deleteExam/'
