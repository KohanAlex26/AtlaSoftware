      ...
      <form className="labelStyle">
        ...
        <input
          ...
          onClick={() => alert("TERMENI SI CONDITII GDPR\n" +
              ...
              "\n" +
              "INTRODUCERE\n" +
              "Prezentele Conditii Generale definesc conditiile de utilizare a site-ului CStudent.ddns.net de catre potentialii vizitatori sau clienti. Accesând si navigând pe acest site, acceptati termenii de utilizare descrisi în continuare.\n" +
              "\n" +
              ...
              "\n" +
              "Întregul continut al site-ului CStudent.ddns.net este protejat prin legea drepturilor de autor, toate drepturile fiind rezervate. Toate drepturile referitoare la pagini, continutul si prezentarea site-ului sunt detinute de AtlaSoftware. Este interzisa copierea, modificarea, afisarea, distribuirea, transmiterea, publicarea, comercializarea, licentierea, crearea unor materiale derivate sau utilizarea continutului site-ului în orice scop fara confirmarea scrisa din partea AtlaSoftware.\n" +
              "\n" +
              "Accesul si utilizarea paginii CStudent.ddns.net sunt gratuite si au scopul de a veni in ajutorul utilizatorilor pentru a gasi informatiile necesare în cel mai usor si rapid mod posibil, conform cerintelor fiecaruia.\n" +
              "\n" +
              "Informatiile prezente pe CStudent.ddns.net sunt de interes general si sunt puse la dispozitia utilizatorilor în mod gratuit. Prin termenul „utilizator” al acestei pagini se întelege orice persoana fizica sau juridica care va accesa pagina. Puteti copia si tipari continutul paginii CStudent.ddns.net pentru folosinta dumneavoastra personala, fara intentii comerciale. În orice alte situatii, continutul CStudent.ddns.net nu poate fi reprodus, modificat sau exploatat fara consimtamântul explicit al reprezentantilor CStudent.ddns.net.\n" +
              "\n" +
              ...
              "\n" +
              "Continutul paginii web CStudent.ddns.net, a informatiilor si a altor materiale prezentate de Comunitatea CStudent.ddns.net nu reprezinta o consultatie juridica în sensul Legii nr. 51/1995.\n" +
              "\n" +
